    ...
    Event Bus 1inl8v4
    =================
    Minimal HTTP service that acts as a forward layer for existing third-party APIs.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Minimal HTTP service that acts as a forward layer for existing third-party APIs.")
